...
<html>
<head>
	<title>疑似异常工单管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="errordocumentList.js" %>
	<style type="text/css">
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">疑似异常工单列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="errordocument" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-2">
				<label class="label-item single-overflow pull-left" title="检查结论：">检查结论：</label>
				<form:select path="checkresult"  class="form-control m-b">
					<form:option value="" label=""/>
					<form:options items="${fns:getDocumentRule()}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-2">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="errordocument:errordocument:add">
				<a id="add" class="btn btn-primary" href="${ctx}/errordocument/errordocument/form" title="疑似异常工单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="errordocument:errordocument:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="errordocument:errordocument:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="errordocument:errordocument:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 导出
	        	</button>
			</shiro:hasPermission>			
			
			<shiro:hasPermission name="errordocument:errordocument:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/errordocument/errordocument/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="errordocumentTable"   data-toolbar="#toolbar"></table>
