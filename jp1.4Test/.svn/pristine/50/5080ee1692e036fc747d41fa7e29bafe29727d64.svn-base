...
<body class="" id="content">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<div class="navbar-header text-center">
			...
			<span class="navbar-brand J_menuItem">全业务申告网络支撑系统 </span>
		</div>
	...
	<aside id="sidebar">
		<div class="sidenav-outer">
			<div class="side-widgets">
				...
				<li class="dropdown admin-dropdown" style="padding-top:1px;">
	...
	<section id="body-container" class="animation" style="overflow: hidden">
