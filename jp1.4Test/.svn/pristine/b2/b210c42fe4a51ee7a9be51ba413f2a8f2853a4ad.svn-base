...
<head>
	...
	<%@include file="overtimefeedbackList.js" %>
	<style type="text/css">
...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="overtimefeedback" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="overtimefeedback:overtimefeedback:add">
				<a id="add" class="btn btn-primary" href="${ctx}/overtimefeedback/overtimefeedback/form" title="反馈超时"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="overtimefeedback:overtimefeedback:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="overtimefeedback:overtimefeedback:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="overtimefeedback:overtimefeedback:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 导出
	        	</button>
			</shiro:hasPermission>			
			
			<shiro:hasPermission name="overtimefeedback:overtimefeedback:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/overtimefeedback/overtimefeedback/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="overtimefeedbackTable"   data-toolbar="#toolbar"></table>
