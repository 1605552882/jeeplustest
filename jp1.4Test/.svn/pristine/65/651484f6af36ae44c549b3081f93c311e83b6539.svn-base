...
<head>
	...
	<%@include file="edMentalassessLogList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">心理社交评估列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="edMentalassessLog" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="mentalassess:edMentalassessLog:add">
			...
			<shiro:hasPermission name="mentalassess:edMentalassessLog:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="mentalassess:edMentalassessLog:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 导出
	        	</button>
			</shiro:hasPermission>			
			
			<shiro:hasPermission name="mentalassess:edMentalassessLog:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/mentalassess/edMentalassessLog/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="edMentalassessLogTable"   data-toolbar="#toolbar"></table>
