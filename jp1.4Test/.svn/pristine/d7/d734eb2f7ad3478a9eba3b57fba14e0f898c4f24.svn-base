...
<head>
	...
	<%@include file="repetitivedocumentList.js" %>
	<style type="text/css">
...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="repetitivedocument" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="repetitivedocument:repetitivedocument:add">
				<a id="add" class="btn btn-primary" href="${ctx}/repetitivedocument/repetitivedocument/form" title="重复退单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="repetitivedocument:repetitivedocument:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="repetitivedocument:repetitivedocument:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="repetitivedocument:repetitivedocument:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 导出
	        	</button>
			</shiro:hasPermission>			
			
			<shiro:hasPermission name="repetitivedocument:repetitivedocument:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/repetitivedocument/repetitivedocument/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="repetitivedocumentTable"   data-toolbar="#toolbar"></table>
