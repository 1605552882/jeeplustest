...
import cn.com.venustech.caserver.common.AuthenModel;
import cn.com.venustech.caserver.common.util.MD5Tool;
import cn.com.venustech.caserver.model.CaAuth;
import cn.com.venustech.caserver.model.LoginResultSet;
...
//		}
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			//List<Menu> usermenulist = UserUtils.getUserMenuList();
			for (Menu menu : list) {
...
//			}
			...
			// 记录登录日志
			LogUtils.saveLog(Servlets.getRequest(), "系统登录","系统登录","登录",LogUtils.LOGIN,"用户："+user.getLoginName()+"登入本系统","","","",Integer.valueOf(LogInterceptor.getConnId()),"",0,"");
			return info;
		} else {
			return null;
		}
