...
public class Role extends DataEntity<Role> {
	...
	private String management_type;//可管理的类型
	private String is_management_type;//是否管理员组
	private String shield_group;//被屏蔽的用户组
	private String network;//区域权限
	private String queryRegion;//可查询的区域
	private String istt;
	...
	public String getIs_management_type() {
		return is_management_type;
	}

	public void setIs_management_type(String is_management_type) {
		this.is_management_type = is_management_type;
	}

	public String getShield_group() {
		return shield_group;
	}

	public void setShield_group(String shield_group) {
		this.shield_group = shield_group;
	}
