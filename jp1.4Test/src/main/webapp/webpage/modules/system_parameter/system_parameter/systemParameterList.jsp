...
<%@include file="systemParameterList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="systemParameter"
				...
				<div id="toolbar">
					<shiro:hasPermission
						name="system_parameter:system_parameter:systemParameter:add">
						<a id="add" class="btn btn-primary"
							href="${ctx}/system_parameter/system_parameter/systemParameter/form"
							title="系统参数"><i class="glyphicon glyphicon-plus"></i> 新建</a>
					</shiro:hasPermission>
					
					<shiro:hasPermission
						name="system_parameter:system_parameter:systemParameter:edit">
					...
					<shiro:hasPermission
						name="system_parameter:system_parameter:systemParameter:del">
					...
					<shiro:hasPermission
						name="system_parameter:system_parameter:systemParameter:export">
					...
					<shiro:hasPermission
						name="system_parameter:system_parameter:systemParameter:import">
						<button id="btnImport" class="btn btn-info">
							<i class="fa fa-folder-open-o"></i> 导入
						</button>
						<div id="importBox" class="hide">
							<form id="importForm"
								action="${ctx}/system_parameter/system_parameter/systemParameter/import"
				...
				<!-- 表格 -->
				<table id="systemParameterTable" data-toolbar="#toolbar"></table>
