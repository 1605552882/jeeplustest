...
<head>
	...
	<%@include file="documentarydetailsList.js" %>
	<style type="text/css">
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="documentarydetails" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-2">
				<label class="label-item single-overflow pull-left" title="故障单号：">故障单号：</label>
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="documentdetect:documentarydetails:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 工单详情
	        	</button>
			</shiro:hasPermission>			
			<shiro:hasPermission name="documentdetect:documentarydetails:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAllFeedback()">
	            	<i class="glyphicon glyphicon-export"></i> 反馈信息
	        	</button>
			</shiro:hasPermission>			
