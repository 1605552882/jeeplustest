...
<%@include file="interfaceConfigList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">测试接口配置</h3>
			</div>
			<div class="panel-body">
				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="interfaceConfig"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="requst：">请求参数：</label>
									<form:input path="requst" htmlEscape="false"
										class=" form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="solu：">解决方案：</label>
									<form:input path="solu" htmlEscape="false"
										class=" form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<div id="toolbar">
					<shiro:hasPermission
						name="interface_config:interface_config:interfaceConfig:add">
						
					</shiro:hasPermission>
					<a id="add" class="btn btn-primary" onclick="add()"><i
							class="glyphicon glyphicon-plus"></i> 新建</a>
					<shiro:hasPermission
						name="interface_config:interface_config:interfaceConfig:edit">
					...
					<shiro:hasPermission
						name="interface_config:interface_config:interfaceConfig:del">
					...
					<shiro:hasPermission
						name="interface_config:interface_config:interfaceConfig:export">
					...
					<shiro:hasPermission
						name="interface_config:interface_config:interfaceConfig:import">
						<button id="btnImport" class="btn btn-info">
							<i class="fa fa-folder-open-o"></i> 导入
						</button>
						<div id="importBox" class="hide">
							<form id="importForm"
								action="${ctx}/interface_config/interface_config/interfaceConfig/import"
				...
				<!-- 表格 -->
				<table id="interfaceConfigTable" data-toolbar="#toolbar"></table>
