...
<body>
	<div class="container-fluid"  style="background-color: white">
	 <form class="form-inline" id="hlrForm">
		<!-- 查询框 -->
		<div class="row" style="border:1px solid #AAAAFF;margin-left:0px;margin-right:0px;padding-bottom:5px;padding-top:5px;margin-top:5px">
			<div class="col-xs-3">
			...
			<div class="col-xs-12" style="padding-left:25px">
				...
				<div class="row" style="margin-top:8px">
					...
					<a  id="update" class="btn btn-danger btn-sm" style="width:80px"><i class="fa fa-refresh"></i> 修改</a>
					<a  id="reset" class="btn btn-success btn-sm" style="width:80px"><i class="fa fa-refresh"></i> CRM比对</a>
					<a  id="reset" class="btn btn-warning btn-sm" style="width:80px"><i class="fa fa-refresh"></i> 批量操作</a>
				</div>
			</div>
