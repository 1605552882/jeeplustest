...
<html>
<head>
	<title>AAA开销户日志</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="anaaaAccountLogWindow.js" %>
	<style type="text/css">
...
<body>
	...
	<!-- 搜索 -->
			...
			<div class="col-xs-12">
				<label class="control-label" title="IMSI号码：">IMSI号码：</label>
			...
			<div class="col-xs-12" style="margin-top:8px">
			  ...
			  <a  id="" class="btn btn-success btn-sm" onClick="exportAccountLog"><i class=""></i> 导出excel</a>
			 </div>
	</form>

	<!-- 表格 -->
	<table id="accountLogTable" data-height="520"></table>
