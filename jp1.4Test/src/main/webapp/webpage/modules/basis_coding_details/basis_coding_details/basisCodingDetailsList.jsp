...
<%@include file="basisCodingDetailsList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">编码明细列表</h3>
			</div>
			<div class="panel-body">
				...
				<!-- 表格 -->
				<table id="basisCodingDetailsTable" data-toolbar="#toolbar"></table>
