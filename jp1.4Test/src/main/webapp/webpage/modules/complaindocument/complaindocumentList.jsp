...
<html>
<head>
	<title>重复投诉工单管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="complaindocumentList.js" %>
	<style type="text/css">
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">重复投诉工单列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="complaindocument" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="complaindocument:complaindocument:add">
				<a id="add" class="btn btn-primary" href="${ctx}/complaindocument/complaindocument/form" title="重复投诉工单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="complaindocument:complaindocument:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="complaindocument:complaindocument:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="complaindocument:complaindocument:export">
				<button id="exportAll" class="btn btn-danger"  onclick="exportAll()">
	            	<i class="glyphicon glyphicon-export"></i> 导出
	        	</button>
			</shiro:hasPermission>			
			
			<shiro:hasPermission name="complaindocument:complaindocument:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/complaindocument/complaindocument/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="complaindocumentTable"   data-toolbar="#toolbar"></table>
