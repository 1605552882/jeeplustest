...
<%@include file="deplSpcilfPortList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">机器部署端口列表</h3>
			</div>
			<div class="panel-body">
				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="deplSpcilfPort"
				...
				<div id="toolbar">
					...
					<shiro:hasPermission
						name="depl_spcilf_port:depl_spcilf_port:deplSpcilfPort:export">
				...
				<!-- 表格 -->
				<table id="deplSpcilfPortTable" data-toolbar="#toolbar"></table>
